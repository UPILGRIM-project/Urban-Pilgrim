...
export default function WorkshopForm() {
    ...
    useEffect(() => {
        if (currentWorkshop) {
            // Ensure sessionTopics have both title and description fields
            const updatedWorkshop = {
                ...currentWorkshop,
                sessionTopics: currentWorkshop.sessionTopics?.map((topic, index) => ({
                    title: topic.title || "",
                    description: topic.description || topic || ""
                })) || [{ title: "", description: "" }]
            };
            setFormData(updatedWorkshop);
            setIsEditing(true);
        }
    }, [currentWorkshop]);
            ...
            <div className="mb-8">
                ...
                <div className="mt-6">
                    ...
                    {formData.sessionTopics.map((topic, index) => (
                        ...
                        >
                            <div className="flex items-center justify-between mb-4">
                                <h4 className="font-medium text-gray-700">Session Topic {index + 1}</h4>
